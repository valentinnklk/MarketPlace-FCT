<?php
// controladores/reseñaControlador.php

require_once __DIR__ . '/../modelo/reseñaModelo.php';
...
class ReseñaControlador {
    ...
    public function crear(): void {
        ...
        if (!$contrato_id || $puntuacion < 1 || $puntuacion > 5) {
            header('Location: reseñaVista.php?contrato_id=' . $contrato_id . '&error=datos');
            exit;
        }
        ...
        if ($id > 0) {
            ...
            header('Location: reseñaVista.php?contrato_id=' . $contrato_id . '&error=no_permitido');
        }
        exit;
    }
}
