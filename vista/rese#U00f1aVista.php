...
<nav class="navbar navbar-dark bg-dark" role="navigation" aria-label="Principal">
            ...
            <div class="card-body">
                ...
                <?php if (!empty($contrato['reseña_id'])): ?>
                    ...
                    <div class="mb-2" style="color:#f5c518; font-size:1.4rem;">
                        <?= str_repeat('<i class="bi bi-star-fill" aria-hidden="true"></i>', (int) $contrato['puntuacion'])
                           . str_repeat('<i class="bi bi-star" aria-hidden="true"></i>', 5 - (int) $contrato['puntuacion']) ?>
                    </div>
                ...
                <form method="POST" action="reseñaVista.php?accion=crear">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="estrellas-seleccion">
                            ...
                            <input type="radio" name="puntuacion" id="p5" value="5"><label for="p5"><i class="bi bi-star-fill" aria-hidden="true"></i></label>
                            <input type="radio" name="puntuacion" id="p4" value="4"><label for="p4"><i class="bi bi-star-fill" aria-hidden="true"></i></label>
                            <input type="radio" name="puntuacion" id="p3" value="3"><label for="p3"><i class="bi bi-star-fill" aria-hidden="true"></i></label>
                            <input type="radio" name="puntuacion" id="p2" value="2"><label for="p2"><i class="bi bi-star-fill" aria-hidden="true"></i></label>
                            <input type="radio" name="puntuacion" id="p1" value="1"><label for="p1"><i class="bi bi-star-fill" aria-hidden="true"></i></label>
                        </div>
